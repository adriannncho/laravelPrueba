...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      columns: [
        { data: 'id', name: 'id' }, // Columna 1: #
        { data: 'name', name: 'name' }, // Columna 2: Nombre
        { data: 'email', name: 'email' }, // Columna 3: Email
        { data: 'roles', name: 'roles' }, // Columna 4: Role
        { data: 'actions', name: 'actions' }, // Columna 5: Actions
      ],
      columnDefs: [
        {
          // For Responsive
